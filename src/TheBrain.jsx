              ...
              <div>
                {hubTab === 'editor' && (
                  <Editor
                    ...
                    projects={projects}
                    setMobileFileTreeOpen={setMobileFileTreeOpen}
                    mobileFileTreeOpen={mobileFileTreeOpen}
                          ...
                          >
                            ...
                            >
                              {getFileType(path) === 'image'
                                ? '📷 Image'
                                : getFileType(path) === 'audio'
                                  ? '🎵 Audio'
                                  : getFileType(path) === 'video'
                                    ? '🎥 Video'
                                    : getFileType(path) === 'binary'
                                      ? '📦 Binary'
                                      : '📄 Text'}
                            </div>
                          </div>
          ...
          <>
            {mainTab === 'command' && (
              <CommandCentre
                ...
                setDriftExpanded={setDriftExpanded}
                driftExpanded={driftExpanded}
                dismissDriftFlag={dismissDriftFlag}
                ...
                setShowOutreachModal={setShowOutreachModal}
