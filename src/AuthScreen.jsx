...
const C = {
  ...
  red:"#ef4444", text:"#cbd5e1", muted:"#475569", dim:"#334155",
...
export default function AuthScreen({ onAuth }) {
  ...
  const inp = {
    ...
    color:"#e2e8f0", fontFamily:C.mono, fontSize:13, padding:"10px 14px",
  ...
  const btn = (variant="primary") => ({
    ...
    color:"#e2e8f0", borderRadius:6, padding:"10px 0", fontSize:12,
    letterSpacing:"0.08em", textTransform:"uppercase", cursor:"pointer",
    fontFamily:C.mono, width:"100%", marginBottom:8,
  });

  return (
    <div style={{
      fontFamily:C.mono, background:C.bg, color:C.text,
      ...
      <div style={{width:380, maxWidth:"95vw"}}>
        ...
        <div style={{textAlign:"center", marginBottom:36}}>
          ...
          <div style={{fontSize:9, color:C.blue, letterSpacing:"0.22em", textTransform:"uppercase"}}>
            Project OS · v6
          </div>
        ...
        <div style={{
            ...
            {["login","register"].map(m => (
              <button key={m} onClick={()=>{setMode(m);setError("");}}
                style={{
                  ...
                  borderBottom: mode===m ? `2px solid ${C.blue2}` : "2px solid transparent",
                }}>
          ...
          {mode==="register" && (
            <input style={inp} placeholder="Name (optional)"
          ...
          {error && (
            <div style={{
              fontSize:10, color:C.red, marginBottom:10,
          ...
          {mode==="login" && (
            <div style={{fontSize:9, color:C.dim, textAlign:"center", marginTop:8}}>
              No account?{" "}
        ...
        <div style={{fontSize:8, color:"#1e293b", textAlign:"center", marginTop:20}}>
